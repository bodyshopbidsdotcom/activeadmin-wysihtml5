...
Now install the migrations (optional):
...
**NOTE:** As support to `dragonfly` has been removed, you don't need to generate the migrations (which is creating the `assets` table).
